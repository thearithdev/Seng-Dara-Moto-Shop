...
const I18N = {
  en: {
    nav_home:"HOME", nav_moto:"MOTORCYCLES", nav_services:"SERVICES", nav_financing:"FINANCING",
    nav_about:"ABOUT US", nav_contact:"CONTACT", book_test_ride:"BOOK A TEST RIDE",
    crumb_home:"Home", crumb_moto:"Motorcycles",
    hero_title:"MOTORCYCLES", hero_subtitle:"Find the perfect motorcycle that matches your style and needs.",
    ...
    footer_quicklinks:"QUICK LINKS", footer_services:"OUR SERVICES", footer_contact_heading:"CONTACT US",
    ...
    footer_address:"#123, National Road 6A, Phnom Penh, Cambodia",
  ...
  km: {
    nav_home:"ទំព័រដើម", nav_moto:"ម៉ូតូ", nav_services:"សេវាកម្ម", nav_financing:"ការទូទាត់រំលស់",
    nav_about:"អំពីយើង", nav_contact:"ទាក់ទង", book_test_ride:"កក់ជិះសាកល្បង",
    crumb_home:"ទំព័រដើម", crumb_moto:"ម៉ូតូ",
    hero_title:"ម៉ូតូ", hero_subtitle:"ស្វែងរកម៉ូតូដែលសាកសមទៅនឹងស្ទីល និងតម្រូវការរបស់អ្នក។",
    ...
    footer_quicklinks:"តំណភ្ជាប់រហ័ស", footer_services:"សេវាកម្មរបស់យើង", footer_contact_heading:"ទាក់ទងមកយើង",
    ...
    footer_address:"ផ្ទះលេខ ១២៣ ជាតិវិថីលេខ៦A ភ្នំពេញ កម្ពុជា",
    footer_hours:"ចន្ទ–អាទិត្យ៖ ៨:០០ព្រឹក – ៦:០០ល្ងាច",
    footer_copyright:"© ២០២៥ ហាងលក់ម៉ូតូ សេងតារា។ រក្សាសិទ្ធិគ្រប់យ៉ាង។",
    footer_privacy:"គោលការណ៍ភាពឯកជន", footer_terms:"លក្ខខណ្ឌប្រើប្រាស់",
